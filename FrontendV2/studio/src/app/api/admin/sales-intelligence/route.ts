...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${BACKEND_API_URL}/api/admin/sales-intelligence`, {
      method: 'GET',
      headers: {
    ...
    console.error('Backend URL:', `${BACKEND_API_URL}/api/admin/sales-intelligence`);
    ...
    return NextResponse.json(
      { 
        ...
        backend_url: `${BACKEND_API_URL}/api/admin/sales-intelligence`
      },
      { status: 500 }
    );
  }
