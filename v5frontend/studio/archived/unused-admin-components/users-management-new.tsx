...
export default function UsersManagement() {
  ...
  const filteredRecruiters = dashboard.recent_activity.recruiters.filter(recruiter =>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{dashboard.overview.total_recruiters}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{dashboard.overview.active_sessions}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{dashboard.overview.total_payments}</div>
            <p className="text-xs text-muted-foreground">
