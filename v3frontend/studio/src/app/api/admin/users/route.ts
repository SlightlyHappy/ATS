...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('👥 Proxying admin users GET to:', url.toString())
    ...
    console.log('👥 Admin users backend response status:', response.status)
    console.log('👥 Admin users backend response:', data)
